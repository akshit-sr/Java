...
class Array <T> implements Iterable <T> {
	...
	public Array(int capacity) {
		if (capacity < 0) throw new IllegalArgumentException("Illegeal Capacity: " + capacity);
...
//	Remove the element at the specificied index in the list.
